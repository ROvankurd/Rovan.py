...
\x1b[38;5;204m        
 .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  _______     | || |     ____     | || | ____   ____  | || |      __      | || | ____  _____  | || |              | || |   ______     | || |  ____  ____  | |
| | |_   __ \    | || |   .'    `.   | || ||_  _| |_  _| | || |     /  \     | || ||_   \|_   _| | || |              | || |  |_   __ \   | || | |_  _||_  _| | |
| |   | |__) |   | || |  /  .--.  \  | || |  \ \   / /   | || |    / /\ \    | || |  |   \ | |   | || |              | || |    | |__) |  | || |   \ \  / /   | |
| |   |  __ /    | || |  | |    | |  | || |   \ \ / /    | || |   / ____ \   | || |  | |\ \| |   | || |              | || |    |  ___/   | || |    \ \/ /    | |
| |  _| |  \ \_  | || |  \  `--'  /  | || |    \ ' /     | || | _/ /    \ \_ | || | _| |_\   |_  | || |      _       | || |   _| |_      | || |    _|  |_    | |
| | |____| |___| | || |   `.____.'   | || |     \_/      | || ||____|  |____|| || ||_____|\____| | || |     (_)      | || |  |_____|     | || |   |______|   | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
def DUMPING():
	os.system('clear')
	banner()
	print('            \x1b[38;5;200mCreator \x1b[38;5;201m: \x1b[38;5;202mSAMO ')
	print('            \x1b[38;5;200mUsername \x1b[38;5;201m: \x1b[38;5;202m@i4m_s4m0 ')
...
def menu():
	os.system('clear')
	banner()
	print('            \x1b[38;5;200mCreator \x1b[38;5;201m: \x1b[38;5;202mRovan ')
	print('            \x1b[38;5;200mUsername \x1b[38;5;201m: \x1b[38;5;202m@Xoshnaw_cc1 ')
	print('            \x1b[38;5;200mTelegram \x1b[38;5;201m: \x1b[38;5;202m@Xoshnaw_cc1 ')
	print('')
